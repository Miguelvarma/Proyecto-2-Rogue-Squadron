  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/my-inventory" element={<ProtectedRoute><WithNavbar><MyInventoryPage /></WithNavbar></ProtectedRoute>} />

        {/* Crear carta — solo ADMIN */}
        <Route path="/create-item"  element={<ProtectedRoute><WithNavbar><CreateItemPage /></WithNavbar></ProtectedRoute>} />
        <Route path="/admin/edit-item/:id" element={<ProtectedRoute><WithNavbar><CreateItemPage /></WithNavbar></ProtectedRoute>} />

        {/* Detalle de producto (armas, pociones, artefactos, etc.) */}
